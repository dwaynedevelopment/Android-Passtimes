package com.dwaynedevelopment.passtimes.base.leaderboard.fragments;
...
import com.dwaynedevelopment.passtimes.base.leaderboard.adapters.LeaderboardViewAdapter;
                                                ...
                                                getActivity().runOnUiThread(() -> {
                                                    ...
                                                    if (playerAdded.getId().equals(mAuth.getCurrentSignedUser().getId())) {
                                                        if (getView() != null) {
                                                            ...
                                                            Glide.with(getActivity().getApplicationContext()).load(playerAdded.getThumbnail()).into(playerRankProfile);
                                                        }
                                                    }
